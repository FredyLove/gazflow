  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-primary text-primary-foreground hover:bg-primary-dark shadow-primary transition-all duration-300 hover:shadow-glow hover:scale-105 animate-pulse-glow",
        glass: "glass-card text-foreground hover:bg-glass-bg/20 border-glass-border hover:border-primary/20 transition-all duration-300",
        gradient: "bg-gradient-accent text-accent-foreground hover:shadow-accent transition-all duration-300 hover:scale-105",
